...
def run(topk, noise):
    ...
    case_file = f"/your_path/{benchmark}/results/{date}_{dataset}_long_agent_{eval_method}_noise{noise}_topk{topk}.json"
    res_file = f"/your_path/{benchmark}/extracted_answer/{date}_{dataset}_long_agent_{eval_method}_noise{noise}_topk{topk}.json"
