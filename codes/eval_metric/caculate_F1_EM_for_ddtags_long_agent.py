...
for topk in topkk:
    for noise in noises:
        input_file = f"/your_path/{benchmark}/extracted_answer/{date}_{dataset}_long_agent_{eval_method}_noise{noise}_topk{topk}.json"
...
output_file = f"/your_path/{benchmark}/tables/{date}_{dataset}_long_agent_{eval_method}_noise{noises}_topk{topkk}.xlsx"
